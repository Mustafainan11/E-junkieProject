...
public class US_303_UnsuccessfulPaymentControlbyCreditCard extends BaseDriver {
    @Test
    public void UnsuccessfulPaymentControlbyCreditCard() throws InterruptedException {
        ...
        Assert.assertTrue(mesaj.getText().contains("Kart numaranız geçersiz."), "Gecersiz Mesaj uyarisi Cikmadi");
